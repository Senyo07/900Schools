                                    ...
                                    >
                                        <div className="flex-1">
                                            ...
                                            <div className="flex gap-2 text-[10px] uppercase font-bold tracking-wider">
                                                <span className={`px-2 py-0.5 rounded ${design.type === 'Portrait' ? 'bg-blue-100 text-blue-700' : 'bg-emerald-100 text-emerald-700'}`}>
                                                    {design.type}
                                                </span>
                            ...
                            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border border-slate-100">
                                ...
                                <div className="flex gap-6">
                                    ...
                                    <button
                                        onClick={handlePrint}
                                        disabled={!!exportingType}
                                        className={`flex flex-col items-center justify-center gap-3 w-40 h-40 bg-slate-50 ${exportingType && exportingType !== 'print' ? 'opacity-50' : 'hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-200'} border-2 border-slate-100 rounded-2xl transition-all group`}
                                    >
                                        {exportingType === 'print'
                                            ? <Loader2 className="w-10 h-10 text-emerald-500 animate-spin" />
                                            : <Printer className="w-10 h-10 text-slate-400 group-hover:text-emerald-600 transition-colors" />}
