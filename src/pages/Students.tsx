                            ...
                            <div>
                                ...
                                <div className="flex gap-2 p-1 bg-slate-100 rounded-lg">
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-1.5 text-xs font-semibold rounded-md transition-colors ${editStudent.status === 'Suspended' ? 'bg-amber-100 text-amber-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                                    >
                                        Suspended
                                    </button>
                                    <button
                        ...
                        <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 p-6 relative flex-shrink-0 rounded-t-2xl">
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="ml-auto mt-auto self-end">
                                    <span className={`px-4 py-1.5 rounded-full text-sm font-bold shadow-sm backdrop-blur-md ${viewingStudent.status === 'Active' ? 'bg-emerald-400/20 text-emerald-100 border border-emerald-400/30' : 'bg-red-400/20 text-red-100 border border-red-400/30'}`}>
                            ...
                            {activeTab === 'behavior' && (
                                <div>
                                    <div className="grid grid-cols-2 gap-4 mb-6">
                                        <div className="bg-white rounded-xl p-5 border border-emerald-200 flex items-center gap-4 shadow-sm shadow-emerald-100/50 relative overflow-hidden group">
                                            <div className="absolute -right-4 -bottom-4 bg-emerald-50 rounded-full w-24 h-24 group-hover:scale-110 transition-transform"></div>
                                            ...
                                            <div className="relative z-10">
                                                <span className="block text-3xl font-black text-emerald-700 leading-none mb-1">5</span>
                                                <span className="text-xs font-bold text-emerald-600/80 uppercase tracking-wider">Total Merits</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="divide-y divide-slate-100">
                                            <div className="p-5 hover:bg-slate-50 transition-colors">
                                                <div className="flex justify-between items-start mb-2">
                                                    <span className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-700 bg-emerald-100 px-2.5 py-1 rounded-md uppercase tracking-wider border border-emerald-200/50">
