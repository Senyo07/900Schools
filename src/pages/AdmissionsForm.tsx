    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col items-center py-12 px-4">
            <div className="w-full max-w-3xl mb-8 flex flex-col items-center">
                <div className="h-16 w-16 bg-emerald-600 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-lg mb-4">LHS</div>
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-3xl border border-slate-200 rounded-2xl bg-white shadow-xl overflow-hidden text-left">
                <div className="bg-emerald-50 border-b border-emerald-100 p-8 text-center">
                    <h3 className="text-2xl font-bold text-emerald-800 mb-2">Student Admission Application</h3>
                    <p className="text-emerald-700">Please fill out all required fields carefully.</p>
                </div>
                ...
                <div className="p-8 space-y-8">
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input required placeholder="E.g., John Doe" className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Date of Birth *</label>
                                <input required type="date" className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" />
                            </div>
                            <div className="md:col-span-2">
                                <label className="block text-sm font-medium text-slate-700 mb-1">Previous School Attended (If any)</label>
                                <input placeholder="School name" className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" />
                            </div>
                            <div className="md:col-span-2">
                                ...
                                <label className="block w-full border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:bg-slate-50 cursor-pointer transition">
                                    ...
                                    <span className="text-sm text-emerald-600 font-medium">Click to browse</span>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input required placeholder="E.g., Jane Doe" className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Phone Number *</label>
                                <input required type="tel" placeholder="+233..." className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Email Address (Optional)</label>
                                <input type="email" placeholder="email@example.com" className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" />
                            </div>
                            <div className="md:col-span-2">
                                <label className="block text-sm font-medium text-slate-700 mb-1">Residential Address *</label>
                                <textarea required rows={3} placeholder="Full address" className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm resize-none" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <label className="block w-full border-2 border-dashed border-slate-300 rounded-xl p-8 flex flex-col items-center justify-center text-slate-500 hover:bg-slate-50 cursor-pointer transition">
                            ...
                            <span className="text-sm font-medium text-emerald-600">Click to upload transcripts and certificates</span>
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="w-full py-4 rounded-xl bg-emerald-600 text-white font-bold text-lg shadow-md hover:bg-emerald-700 transition flex items-center justify-center disabled:opacity-70"
                        >
                            {isSubmitting ? (
