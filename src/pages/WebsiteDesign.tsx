                        ...
                        <div className="p-8">
                            ...
                            <div className="mt-8 pt-8 border-t border-slate-300">
                                <div className="mt-8 border border-slate-200 rounded-xl bg-white shadow-sm overflow-hidden text-center p-8">
                                    ...
                                    <a href="/admissions" target="_blank" rel="noopener noreferrer" className="inline-block bg-emerald-600 text-white font-bold px-8 py-3 rounded-xl hover:bg-emerald-700 transition shadow-md hover:shadow-lg">
        ...
        <div className="space-y-2">
            ...
            {polishOptions?.field === field ? (
                ...
                <textarea
                    ...
                    className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm resize-none"
                ></textarea>
            )}
        </div>
    );
                ...
                <div className="xl:col-span-1 space-y-6">
                    <section className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                        ...
                        <div className="space-y-5">
                                    ...
                                    {themes.map(theme => (
                                        <button
                                            ...
                                            className={`text-left px-4 py-3 rounded-lg border text-sm transition-all ${themeName === theme
                                                ? 'border-emerald-500 bg-emerald-50 text-emerald-700 font-medium tracking-wide shadow-inner'
                            ...
                            <div className="pt-4 border-t border-slate-100">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <button
                                        ...
                                        className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl border border-dashed border-slate-300 hover:bg-slate-50 text-slate-500 hover:text-emerald-600 hover:border-emerald-300 transition-colors"
                                    >
                            ...
                            <button className="w-full py-2.5 rounded-lg bg-emerald-950 text-white font-medium text-sm hover:bg-emerald-900 transition-colors shadow-sm">
                                Publish Changes
                            </button>
                        </div>
                    </section>
                ...
                <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl w-full max-w-3xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-6 overflow-y-auto flex-1 space-y-8">
                            <div className="space-y-4">
                                <h3 className="text-sm font-bold uppercase tracking-wider text-emerald-700">School Details</h3>
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-emerald-500 text-sm font-medium"
                                    />
                                </div>
                            </div>
