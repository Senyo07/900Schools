                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-full max-h-[400px]">
                        ...
                        <div className="p-4 bg-slate-50 border-b border-slate-100 shrink-0">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
                                />
                                <button
                                    onClick={handleAddProgram}
                                    className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition shadow-sm flex items-center gap-1"
                                >
                        ...
                        <div className="p-4 overflow-y-auto flex-1 bg-white">
                            <ul className="space-y-2 pr-2">
                                {programs.map((prog, i) => (
                                    <li key={i} className="flex justify-between items-center p-3 bg-slate-50 hover:bg-blue-50/50 transition-colors rounded-xl border border-slate-100 group">
