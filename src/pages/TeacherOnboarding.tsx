                ...
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-slate-100">
                    <form onSubmit={handleSubmit} className="p-8 space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                ...
                                <div className="flex flex-col flex-1 items-center sm:items-start space-y-3">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-6 py-2.5 bg-white border border-slate-300 rounded-xl text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-emerald-700 hover:border-emerald-300 transition-all shadow-sm"
                                    >
                        ...
                        <div className="pt-6 border-t border-slate-100">
                            <h3 className="text-sm font-bold uppercase tracking-widest text-emerald-700 mb-6 flex items-center gap-2">
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all text-slate-800"
                                    />
                                </div>

                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1.5 flex items-center gap-2">
                                        <BookOpen className="w-4 h-4 text-emerald-600" /> Subject(s) Taught
                                    </label>
                                    <input
                                        type="text"
                                        required
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1.5 flex items-center gap-2">
                                        <FileText className="w-4 h-4 text-emerald-600" /> Brief Biography
                                    </label>
                                    <textarea
                                        required
                                        rows={4}
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all text-slate-800 resize-none"
                                    ></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-8">
                            <button
                                ...
                                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-md hover:shadow-lg disabled:bg-emerald-400 flex items-center justify-center"
                            >
                                {isSubmitting ? (
