            ...
            <div className="space-y-8 animate-in fade-in duration-300">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity"><Users className="w-16 h-16 text-blue-600" /></div>
                        ...
                        <div className="text-xs text-blue-600 mt-3 font-medium flex items-center gap-1"><span className="bg-blue-100 rounded px-1">+12%</span> from last year</div>
                    </div>
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity"><Users className="w-16 h-16 text-blue-600" /></div>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity"><CreditCard className="w-16 h-16 text-blue-600" /></div>
                        ...
                        <div className="text-xs text-blue-600 mt-3 font-medium">From admissions</div>
                    </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <Link to="/website-design" className="block p-5 border border-slate-100 bg-slate-50 hover:border-blue-300 hover:bg-blue-50 rounded-2xl text-left transition-all duration-300 group shadow-sm hover:shadow-md">
                        ...
                        <Link to="/students" className="block p-5 border border-slate-100 bg-slate-50 hover:border-blue-300 hover:bg-blue-50 rounded-2xl text-left transition-all duration-300 group shadow-sm hover:shadow-md">
                            <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <Link to="/teacher" className="block p-5 border border-slate-100 bg-slate-50 hover:border-blue-300 hover:bg-blue-50 rounded-2xl text-left transition-all duration-300 group shadow-sm hover:shadow-md">
                            <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <Link to="/admissions" className="block p-5 border border-slate-100 bg-slate-50 hover:border-blue-300 hover:bg-blue-50 rounded-2xl text-left transition-all duration-300 group shadow-sm hover:shadow-md">
                            <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <button className="block p-5 border border-slate-100 bg-slate-50 hover:border-blue-300 hover:bg-blue-50 rounded-2xl text-left transition-all duration-300 group shadow-sm hover:shadow-md">
                            <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                                <Layout className="w-6 h-6 text-blue-600" />
                            </div>
